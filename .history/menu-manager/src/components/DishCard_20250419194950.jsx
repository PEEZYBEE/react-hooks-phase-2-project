function DishCard({ dish, onDelete, onToggleAvailability, index }) {
  return (
    <div
      className="bg-white rounded-2xl shadow-md p-4 transform transition-transform duration-300 hover:scale-105 hover:shadow-xl animate-fade-in hover:animate-wobble"
